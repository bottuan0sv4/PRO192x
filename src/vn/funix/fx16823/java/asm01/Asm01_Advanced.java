package vn.funix.fx16823.java.asm01;

import java.util.Random;
import java.util.Scanner;

public class Asm01_Advanced {
    ...
    public static String taoMaXacThucString(int length){
        String alphabet = new String("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz");
        int n = alphabet.length();

        String maxacthuc = new String();
        Random r = new Random();

        for (int i=0; i<length; i++)
            maxacthuc = maxacthuc + alphabet.charAt(r.nextInt(n));
...
//        System.out.println(songaunhien);
    ...
    public static void main(String[] args) {
        // Giao dien
        System.out.println("+----------+--------------------+----------+");
        System.out.println("| NGAN HANG SO | FX16823@v1.0.0            |");
        System.out.println("+----------+--------------------+----------+");
        ...
        if (chucnang == 1) {
            //Tao ma xac thuc
            String maxacthuc = taoMaXacThucString(6);
            System.out.println("Nhap ma xac thuc: " + maxacthuc );

            // Nhap ma xac thuc
            String maxacnhan = sc.next();
            while (maxacnhan.equals(maxacthuc) == false) {
